...
import com.jhipster.ecommerce.product.web.rest.errors.BadRequestAlertException;
import java.net.URI;
...
/**
 * REST controller for managing {@link com.jhipster.ecommerce.product.domain.OrderItem}.
 */
@RestController
@RequestMapping("/api")
